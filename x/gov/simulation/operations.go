...
func randomDeposit(
	...
	if useMinAmount {
		minDepositPercent := depositParams.MinInitialDepositPercent
		minAmount = minDepositAmount.ToDec().Mul(sdk.NewDec(int64(minDepositPercent))).Quo(sdk.NewDec(100)).RoundInt()
	}
