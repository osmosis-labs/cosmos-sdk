...
func TestTallyParamsGetThreshold(t *testing.T) {
	testcases := []struct {
		...
		},
		{
			...
			tallyParams:   types.NewTallyParams(types.DefaultQuorum, types.DefaultThreshold, sdk.NewDecWithPrec(777, 3), types.DefaultVetoThreshold, types.DefaultExpeditedQuorumThreshold),
			expectedValue: sdk.NewDecWithPrec(777, 3),
			isExpedited:   true,
		},
		{
			name:          "default not expedited",
			tallyParams:   types.NewTallyParams(types.DefaultQuorum, sdk.NewDecWithPrec(6, 1), types.DefaultExpeditedThreshold, types.DefaultVetoThreshold, types.DefaultExpeditedQuorumThreshold),
